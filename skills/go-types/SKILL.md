---
name: go-types
description: Implement or review the types layer for a Go service following architecture standards
argument-hint: <ServiceName>
allowed-tools: [Read, Glob, Grep, Edit, Write, Bash]
---

Implement or review the types layer for $ARGUMENTS following the specs below exactly.
